                    ...
                    columns: [
                        ...
                        { 
			        	    ...
			        	    render: function(data, type, row) {
                                var ret = [];
                                for( var i = 0 ; i < row.artists.length ; i++ ) {
                                    ret.push(' ' + row.artists[i].artist.first_name + ' ' + row.artists[i].artist.last_name);
                                }
                                return ret.toString();
                            }
                        },
                        { 
			        	    ...
			        	    render: function(data, type, row) {
                                var ret = [];
                                for( var i = 0 ; i < row.publishers.length ; i++ ) {
                                    ret.push(' ' + row.publishers[i].publisher.publisher_name);
                                }
                                return ret.toString();
                            }
                        },
